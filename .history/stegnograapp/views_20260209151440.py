...
def profile(request):
    if 'email' in request.session:
        ...
        try:
            ...
            # Fetch stats (detail) object
            d = detail.objects.first()
            if not d:
                d = detail.objects.create() # Create if missing to prevent errors
            
            # 1. CALCULATE STATS
            # Helper list of all encode fields
            encodes = [
                d.encode_text_in_image_number or 0, d.encode_image_in_image_number or 0,
                d.encode_video_in_image_number or 0, d.encode_audio_in_image_number or 0,
                d.encode_text_in_video_number or 0, d.encode_image_in_video_number or 0,
                d.encode_audio_in_video_number or 0, d.encode_video_in_video_number or 0,
                d.encode_text_in_audio_number or 0, d.encode_image_in_audio_number or 0,
                d.encode_audio_in_audio_number or 0, d.encode_video_in_audio_number or 0
            ]
            
            # Helper list of all decode fields
            decodes = [
                d.decode_text_in_image_number or 0, d.decode_image_in_image_number or 0,
                d.decode_video_in_image_number or 0, d.decode_audio_in_image_number or 0,
                d.decode_text_in_video_number or 0, d.decode_image_in_video_number or 0,
                d.decode_audio_in_video_number or 0, d.decode_video_in_video_number or 0,
                d.decode_text_in_audio_number or 0, d.decode_image_in_audio_number or 0,
                d.decode_audio_in_audio_number or 0, d.decode_video_in_audio_number or 0
            ]
            ...
            # Calculate Days Active (approximate using the creation date of the stats row)
