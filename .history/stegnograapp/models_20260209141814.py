...
class detail(models.Model):
    ...
    files_processed_number=models.IntegerField(null=True,blank=True)
    encode_number=models.IntegerField(null=True,blank=True)
    decode_number=models.IntegerField(null=True,blank=True)
    encode_text_in_image_number=models.IntegerField(null=True,blank=True)
    decode_text_in_image_number=models.IntegerField(null=True,blank=True)
    encode_image_in_image_number=models.IntegerField(null=True,blank=True)
    decode_image_in_image_number=models.IntegerField(null=True,blank=True)
    encode_video_in_image_number=models.IntegerField(null=True,blank=True)
    decode_video_in_image_number=models.IntegerField(null=True,blank=True)
    encode_audio_in_image_number=models.IntegerField(null=True,blank=True)
    decode_audio_in_image_number=models.IntegerField(null=True,blank=True)
    encode_text_in_video_number=models.IntegerField(null=True,blank=True)
    decode_text_in_video_number=models.IntegerField(null=True,blank=True)
    encode_image_in_video_number=models.IntegerField(null=True,blank=True)
    decode_image_in_video_number=models.IntegerField(null=True,blank=True)
    encode_text_in_audio_number=models.IntegerField(null=True,blank=True)
    decode_text_in_audio_number=models.IntegerField(null=True,blank=True)
    encode_image_in_audio_number=models.IntegerField(null=True,blank=True)
    decode_image_in_audio_number=models.IntegerField(null=True,blank=True)
